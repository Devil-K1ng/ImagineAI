...
const Header = () => {
  ...
  return (
    ...
    >
        ...
        <motion.h1 className='text-4xl max-w-[300px] sm:text-6xl sm:max-w-[590px] mx-auto mt-10 text-center'>Turn ideas into <span className='text-blue-600'
        initial={{opacity:0}}
        animate={{opacity:1}}
        ...
        className='mt-2 text-neutral-600'>Generated images from ImagineAI</motion.p>
    </motion.div>
  )
}
